...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference("Widget.count") do
      post widgets_url, params: { widget: { cost: @widget.cost, name: @widget.name, size: @widget.size, stock: @widget.stock, toxic: @widget.toxic } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { cost: @widget.cost, name: @widget.name, size: @widget.size, stock: @widget.stock, toxic: @widget.toxic } }
